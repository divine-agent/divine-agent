...
class RunScope(_message.Message):
    __slots__ = ("run_id", "attributes", "dropped_attributes_count")
    ...
    def __init__(self, run_id: _Optional[bytes] = ..., attributes: _Optional[_Iterable[_Union[KeyValue, _Mapping]]] = ..., dropped_attributes_count: _Optional[int] = ...) -> None: ...
