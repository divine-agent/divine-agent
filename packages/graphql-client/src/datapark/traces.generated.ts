...
export type GetTracesQuery = { __typename?: 'Query', traces?: Array<{ __typename?: 'Trace', id: string, name?: string | null, start_time: string, session_id: string, end_time: { __typename?: 'NullTime', Time: string, Valid: boolean } }> | null };

export type GetAllTracesQueryVariables = Types.Exact<{ [key: string]: never; }>;
...
export type GetSpansQuery = { __typename?: 'Query', spans?: Array<{ __typename?: 'Span', id: string, parent_id: string, trace_id: string, name: string, start_time: string, duration?: number | null, kind: Types.Kind, metadata?: Array<{ __typename?: 'KeyValue', key: string, value: string }> | null, end_time: { __typename?: 'NullTime', Time: string, Valid: boolean } }> | null };
