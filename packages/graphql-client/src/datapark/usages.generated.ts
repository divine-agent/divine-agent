...
export type GetCompletionUsageQuery = { __typename?: 'Query', completion_usage?: Array<{ __typename?: 'UsageResult', input_tokens: number, output_tokens: number, total_tokens: number, model?: string | null, date?: number | null }> | null };
